...
import com.devlach.patters.pipeline.fibonacci.ReverseFibonacciLoadStep;

public class PipelineExample {
    public static void main(String[] args) {
        var pipeline = new EtlPipeLine<>(new FibonacciNumbersInputExtracStep())
                .addStep(new FibonacciTransformStep())
                .addStep(new ReverseFibonacciLoadStep());

        System.out.println(pipeline.execute("hsdhs,sds,1,2,a,3,4,5,6,7,8,9,10"));
